		...
		<ul>
			...
			<# if ( data.size ) { #>
				<li class="typography-font-size">
					...
					<input type="text" name="{{ data.size.name }}" value="{{ data.size.value }}" placeholder="<?php esc_html_e( 'px - em - rem', 'pdvs-portfolio' ); ?>" />
			...
			<# if ( data.line_height ) { #>
				<li class="typography-line-height">
					...
					<input type="text" name="{{ data.line_height.name }}" value="{{ data.line_height.value }}" placeholder="<?php esc_html_e( 'px - em - rem', 'pdvs-portfolio' ); ?>" />
			...
			<# if ( data.spacing ) { #>
				<li class="typography-letter-spacing">
					...
					<input type="text" name="{{ data.spacing.name }}" value="{{ data.spacing.value }}" placeholder="<?php esc_html_e( 'px - em - rem', 'pdvs-portfolio' ); ?>" />
