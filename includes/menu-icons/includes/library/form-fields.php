 ...
 * Form Fields
 */
abstract class RelicWP_Form_Field {
	...
	protected static $types = array(
		'text'            => 'RelicWP_Form_Field_Text',
		'number'          => 'RelicWP_Form_Field_Text',
		'url'             => 'RelicWP_Form_Field_Text',
		'color'           => 'RelicWP_Form_Field_Text',
		'date'            => 'RelicWP_Form_Field_Text',
		'hidden'          => 'RelicWP_Form_Field_Text',
		'checkbox'        => 'RelicWP_Form_Field_Checkbox',
		'radio'           => 'RelicWP_Form_Field_Radio',
		'textarea'        => 'RelicWP_Form_Field_Textarea',
		'select'          => 'RelicWP_Form_Field_Select',
		'select_multiple' => 'RelicWP_Form_Field_Select_Multiple',
		'select_pages'    => 'RelicWP_Form_Field_Select_Pages',
		'special'         => 'RelicWP_Form_Field_Special',
	);
	...
	*/
	...
	final public static function create( array $field, $args = array() ) {
		...
		if ( ! isset( self::$types[ $field['type'] ] )
			...
			trigger_error(
				sprintf(
					esc_html__( '%1$s: Type %2$s is not supported, reverting to text.', 'relicwp-helper' ),
					__CLASS__,
					esc_html( $field['type'] )
				),
				E_USER_WARNING
 ...
 * Field: text
 */
class RelicWP_Form_Field_Text extends RelicWP_Form_Field {
 ...
 * Field: Textarea
 */
class RelicWP_Form_Field_Textarea extends RelicWP_Form_Field {
 ...
 * Field: Checkbox
 */
class RelicWP_Form_Field_Checkbox extends RelicWP_Form_Field {
 ...
 * Field: Radio
 */
class RelicWP_Form_Field_Radio extends RelicWP_Form_Field_Checkbox {
 ...
 * Field: Select
 */
class RelicWP_Form_Field_Select extends RelicWP_Form_Field {
	...
	public function render() {
		?>
		<select<?php echo wp_kses_post( $this->build_attributes() ) // xss ok ?>>
 ...
 */
class RelicWP_Form_Field_Select_Multiple extends RelicWP_Form_Field_Select {
 ...
 * Field: Select Pages
 */
class RelicWP_Form_Field_Select_Pages extends RelicWP_Form_Field_Select {
 ...
 */
class RelicWP_Form_Field_Special extends RelicWP_Form_Field {
	public function render() {
