 ...
 *
 */
class RelicWP_Icon_Picker_Type_Image extends RelicWP_Icon_Picker_Type {
	...
	public function __construct( $args = array() ) {
		if ( empty( $this->name ) ) {
			$this->name = __( 'Image', 'relicwp-helper' );
		}
	...
	public function get_templates() {
		 ...
		 *
		 */
		$templates = apply_filters( 'relicwp_icon_picker_image_media_templates', $templates );
	...
	protected function get_image_mime_types() {
		 ...
		 *
		 */
		$mime_types = apply_filters( 'relicwp_icon_picker_image_mime_types', $mime_types );
