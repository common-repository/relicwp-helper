 ...
 */
class RelicWP_Icon_Picker_Type {
	...
	public function get_props() {
		 ...
		 *
		 */
		$props = apply_filters( 'relicwp_icon_picker_type_props', $props, $this->id, $this );

		/**
		 * Filter icon type properties
		 *
		 */
		$props = apply_filters( "relicwp_icon_picker_type_props_{$this->id}", $props, $this );
