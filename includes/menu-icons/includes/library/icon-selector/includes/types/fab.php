 ...
 *
 */
class RelicWP_Icon_Picker_Type_Font_Awesome_Brand extends RelicWP_Icon_Picker_Type_Font {
	...
	public function get_groups() {
		 ...
		 *
		 */
		$groups = apply_filters( 'relicwp_icon_picker_fab_groups', $groups );
	...
	public function get_items() {
		 ...
		 *
		 */
		$items = apply_filters( 'relicwp_icon_picker_fab_items', $items );
