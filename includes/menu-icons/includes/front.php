 ...
 *
 */
final class RelicWP_Menu_Icons_Front_End {
	...
	public static function init() {
		$active_types = RelicWP_Menu_Icons_Settings::get( 'global', 'icon_types' );

		if ( empty( $active_types ) ) {
			return;
		}

		foreach ( RelicWP_Menu_Icons::get( 'types' ) as $type ) {
		 ...
		 *
		 */
		self::$hidden_label_class = apply_filters( 'relicwp_menu_icons_hidden_label_class', self::$hidden_label_class );

		/**
		 * Allow themes/plugins to override default inline style
		 *
		 */
		self::$default_style = apply_filters( 'relicwp_menu_icons_default_style', self::$default_style );
	...
	public static function _add_icon( $title, $id ) {
		$meta = RelicWP_Menu_Icons_Meta::get( $id );
		 ...
		 */
		$title_with_icon = apply_filters( 'pt_menu_icons_item_title', $title_with_icon, $id, $meta, $title );
