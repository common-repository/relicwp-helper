...
if ( ! class_exists( 'RelicWP_Helper_Social_Widget' ) ) {
	class RelicWP_Helper_Social_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			$this->social_services_array = apply_filters( 'pdvs_social_widget_profiles', array(
				'twitter' => array(
					'name' => 'Twitter',
					'url'  => '',
				),
			...
			parent::__construct(
				'pdvs_social',
				esc_html__( '&raquo; Social Icons', 'relicwp-helper' ),
				array(
					'classname'   => 'widget-pdwp-social social-widget',
					'description' => esc_html__( 'Display your social media icons.', 'relicwp-helper' ),
		...
		public function social_widget_style() { ?>
			<style>
				.pdwp-social-widget-services-list { padding-top: 10px; }
				.pdwp-social-widget-services-list li { cursor: move; background: #fafafa; padding: 10px; border: 1px solid #e5e5e5; margin-bottom: 10px; }
				.pdwp-social-widget-services-list li p { margin: 0 }
				.pdwp-social-widget-services-list li label { margin-bottom: 3px; display: block; color: #222; }
				.pdwp-social-widget-services-list li label span.fa { margin-right: 10px }
				.pdwp-social-widget-services-list li label span.fab { margin-right: 10px }
				.pdwp-social-widget-services-list .placeholder { border: 1px dashed #e3e3e3 }
			...
			<script>
				( function( $ ){
					$(document).ajaxSuccess(function(e, xhr, settings) {
						var widget_id_base = 'pdvs_social';
					...
					function pdwpSortServices() {
						$( '.pdwp-social-widget-services-list' ).each( function() {
							var id = $(this).attr( 'id' );
							$( '#'+ id ).sortable( {
		...
		public function widget( $args, $instance ) {
			...
			echo $args['before_widget'];
				...
				<ul class="pdwp-social-icons <?php echo esc_attr( $transition ); ?> style-<?php echo esc_attr( $style ); ?>">
					<?php
					// Original Array
					...
					foreach( $social_services as $key => $val ) {
						...
						if ( $link ) {
							...
							echo '<li class="pdwp-'. esc_attr( $key ) .'">';
		...
		public function form( $instance ) {
			...
			$instance = wp_parse_args( ( array ) $instance, array(
				'title'           	 => esc_attr__( 'Follow Us', 'relicwp-helper' ),
				'style' 	  		 => esc_html__( 'Light', 'relicwp-helper' ),
				'transition' 	  	 => esc_html__( 'Rotate', 'relicwp-helper' ),
				'font_size'       	 => '',
				'border_radius'   	 => '',
				'bg_color'   	     => '',
				'bg_hover_color'   	 => '',
			...
			<p>
				...
				<select class='widefat' name="<?php echo esc_attr( $this->get_field_name( 'style' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'style' ) ); ?>">
					<option value="light" <?php selected( $instance['style'], 'light' ) ?>><?php esc_html_e( 'Light', 'relicwp-helper' ); ?></option>
					<option value="dark" <?php selected( $instance['style'], 'dark' ) ?>><?php esc_html_e( 'Dark', 'relicwp-helper' ); ?></option>
					<option value="colored" <?php selected( $instance['style'], 'colored' ) ?>><?php esc_html_e( 'Colored', 'relicwp-helper' ); ?></option>
					<option value="simple" <?php selected( $instance['style'], 'simple' ) ?>><?php esc_html_e( 'Simple', 'relicwp-helper' ); ?></option>
				</select>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'transition' ) ); ?>"><?php esc_html_e( 'Transition:', 'relicwp-helper' ); ?></label>
				<select class='widefat' name="<?php echo esc_attr( $this->get_field_name( 'transition' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'transition' ) ); ?>">
					<option value="no-transition" <?php selected( $instance['transition'], 'no-transition' ) ?>><?php esc_html_e( 'None', 'relicwp-helper' ); ?></option>
					<option value="float" <?php selected( $instance['transition'], 'float' ) ?>><?php esc_html_e( 'Float', 'relicwp-helper' ); ?></option>
					<option value="rotate" <?php selected( $instance['transition'], 'rotate' ) ?>><?php esc_html_e( 'Rotate', 'relicwp-helper' ); ?></option>
					<option value="zoomout" <?php selected( $instance['transition'], 'zoomout' ) ?>><?php esc_html_e( 'Zoom Out', 'relicwp-helper' ); ?></option>
				</select>
			</p>
			...
			<p>
				...
				<br />
				<select class="pdwp-widget-select" name="<?php echo esc_attr( $this->get_field_name( 'target' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>">
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'size' ) ); ?>"><?php esc_html_e( 'Dimensions', 'relicwp-helper' ); ?>:</label>
				...
				<small><?php esc_html_e( 'Example:', 'relicwp-helper' ); ?> 40px</small>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'font_size' ) ); ?>"><?php esc_html_e( 'Font Size', 'relicwp-helper' ); ?>:</label>
				...
				<small><?php esc_html_e( 'Example:', 'relicwp-helper' ); ?> 18px</small>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'border_radius' ) ); ?>"><?php esc_html_e( 'Border Radius', 'relicwp-helper' ); ?></label>
				...
				<small><?php esc_html_e( 'Example:', 'relicwp-helper' ); ?> 4px</small>
			</p>

			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'bg_color' ) ); ?>"><?php esc_html_e( 'Background Color', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'bg_hover_color' ) ); ?>"><?php esc_html_e( 'Background Color Hover', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'color' ) ); ?>"><?php esc_html_e( 'Color', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'color_hover' ) ); ?>"><?php esc_html_e( 'Color Hover', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'border_color' ) ); ?>"><?php esc_html_e( 'Border Color', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'border_hover_color' ) ); ?>"><?php esc_html_e( 'Border Color Hover', 'relicwp-helper' ); ?></label>
			...
			<ul id="<?php echo esc_attr( $field_id_services ); ?>" class="pdwp-social-widget-services-list">
		...
		public function colors( $args, $instance ) {
			...
			if ( $bg_color || $bg_hover_color
				...
				<style>
					#<?php echo $id; ?>.widget-pdwp-social ul li a {
					...
					#<?php echo $id; ?>.widget-pdwp-social ul li a:hover {
...
register_widget( 'RelicWP_Helper_Social_Widget' );