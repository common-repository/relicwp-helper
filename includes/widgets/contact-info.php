...
if ( ! class_exists( 'RelicWP_Helper_Contact_Info_Widget' ) ) {
	class RelicWP_Helper_Contact_Info_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				'pdvs_contact_info',
				esc_html__( '&raquo; Contact Info', 'relicwp-helper' ),
				array(
					'classname'   => 'widget-pdwp-contact-info',
					'description' => esc_html__( 'Adds support for contact info.', 'relicwp-helper' ),
		...
		public function social_widget_style() { ?>
			<style>
				.pdwp-infos { background: #fafafa; padding: 16px 10px; border: 1px solid #e5e5e5; margin-bottom: 10px; }
				.pdwp-infos h2 { font-size: 16px; margin: 0 0 10px; }
				.pdwp-infos p { margin: 0 0 8px; }
				.pdwp-infos p:last-child { margin: 0; }
				.pdwp-infos label { margin-bottom: 3px; display: block; color: #222; }
			</style>
		<?php
		}
				...
				echo '<ul class="contact-info-widget '. esc_attr( $style ) .'">';
					...
					if ( $address ) {
						echo '<li class="address">';
							...
							echo '<div class="pdwp-info-wrap">';
								echo '<span class="pdwp-contact-title">'. esc_html( $address_text ) .'</span>';
									if( ! empty($address_link) ) {
										echo '<a href="'. esc_url( $address_link ) .'" target="_'. esc_attr( $target ) .'">';
									}
									echo '<span class="pdwp-contact-text">'. esc_html( $address ) .'</span>';
									if( ! empty($address_link) ) {
										echo '</a>';
									}
							echo '</div>';
					...
					if ( $phone ) {
						echo '<li class="phone">';
							...
							echo '<div class="pdwp-info-wrap">';
								echo '<span class="pdwp-contact-title">'. esc_html( $phone_text ) .'</span>';
									if( ! empty($phone_link) ) {
										echo '<a href="tel:'. esc_attr( $phone_link ) .'">';
									}
									echo '<span class="pdwp-contact-text">'. esc_html( $phone ) .'</span>';
									if( ! empty($phone_link) ) {
										echo '</a>';
									}
							echo '</div>';
					...
					if ( $mobile ) {
						echo '<li class="mobile">';
							...
							echo '<div class="pdwp-info-wrap">';
								echo '<span class="pdwp-contact-title">'. esc_html( $mobile_text ) .'</span>';
									if( ! empty($mobile_link) ) {
										echo '<a href="tel:'. esc_attr( $mobile_link ) .'">';
									}
									echo '<span class="pdwp-contact-text">'. esc_html( $mobile ) .'</span>';
									if( ! empty($mobile_link) ) {
										echo '</a>';
									}
							echo '</div>';
					...
					if ( $fax ) {
						echo '<li class="fax">';
							...
							echo '<div class="pdwp-info-wrap">';
								echo '<span class="pdwp-contact-title">'. esc_html( $fax_text ) .'</span>';
								echo '<span class="pdwp-contact-text">'. esc_html( $fax ) .'</span>';
							echo '</div>';
						echo '</li>';
					}
					...
					if ( $email ) {
						echo '<li class="email">';
							...
							echo '<div class="pdwp-info-wrap">';
								echo '<span class="pdwp-contact-title">'. esc_html( $email_text ) .'</span>';
								echo '<span class="pdwp-contact-text">';
					...
					if ( $web ) {
						echo '<li class="web">';
							...
							echo '<div class="pdwp-info-wrap">';
								echo '<span class="pdwp-contact-title">'. esc_html( $web_text ) .'</span>';
								echo '<span class="pdwp-contact-text">';
					...
					if ( $skype ) {
						echo '<li class="skype">';
							echo '<a href="skype:'. esc_attr( $skype ) .'?call" target="_self" class="pdwp-skype-button">';
								if($skypetxt) {
									echo esc_html( $skypetxt );
								} else {
									esc_html__('Skype', 'relicwp-helper');
								}
							echo '</a>';
						echo '</li>';
					}
		...
		public function form( $instance ) {
			...
			$instance = wp_parse_args( (array) $instance, array(
				'title'         => esc_attr__( 'Contact Info', 'relicwp-helper' ),
				'style' 		=> esc_attr__( 'Default', 'relicwp-helper' ),
				...
				'address_text'  => esc_attr__( 'Address:', 'relicwp-helper' ),
				'address'       => esc_attr__( 'Street Name, FL 54785', 'relicwp-helper' ),
				'address_link'  => '',
				'phone_icon'  	=> 'icon-phone',
				'phone_text'  	=> esc_attr__( 'Phone:', 'relicwp-helper' ),
				'phone' 		=> '621-254-2147',
				'phone_link' 	=> '',
				'mobile_icon'  	=> 'icon-screen-smartphone',
				'mobile_text'  	=> esc_attr__( 'Mobile:', 'relicwp-helper' ),
				'mobile' 		=> '621-254-2147',
				'mobile_link'  	=> '',
				'fax_icon'  	=> 'icon-printer',
				'fax_text'  	=> esc_attr__( 'Fax:', 'relicwp-helper' ),
				'fax' 			=> '621-254-2147',
				'email_icon'  	=> 'icon-envelope',
				'email_text'  	=> esc_attr__( 'Email:', 'relicwp-helper' ),
				'email' 		=> 'contact@support.com',
				'emailtxt' 		=> 'contact@support.com',
				'web_icon'  	=> 'icon-link',
				'web_text'  	=> esc_attr__( 'Website:', 'relicwp-helper' ),
				'web' 			=> '#',
				'webtxt' 		=> 'yourwebsite.com',
				'skype' 		=> 'YourUsername',
				'skypetxt' 		=> esc_html__( 'Skype Call Us', 'relicwp-helper' ),
			) ); ?>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'style' ) ); ?>"><?php esc_html_e( 'Style', 'relicwp-helper' ); ?></label>
				<select class='widefat' name="<?php echo $this->get_field_name( 'style' ); ?>" id="<?php echo $this->get_field_id( 'style' ); ?>">
					<option value="default" <?php if ( $instance['style'] == 'default') { ?>selected="selected"<?php } ?>><?php esc_html_e( 'Default', 'relicwp-helper' ); ?></option>
					<option value="big-icons" <?php if ( $instance['style'] == 'big-icons') { ?>selected="selected"<?php } ?>><?php esc_html_e( 'Big Icons', 'relicwp-helper' ); ?></option>
					<option value="no-icons" <?php if ( $instance['style'] == 'no-icons') { ?>selected="selected"<?php } ?>><?php esc_html_e( 'No Icons', 'relicwp-helper' ); ?></option>
				</select>
			</p>

			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'text' ) ); ?>"><?php esc_html_e( 'Text', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'target' ) ); ?>"><?php esc_html_e( 'Links Target', 'relicwp-helper' ); ?></label>
			...
			<div class="pdwp-infos">
				<h2><?php esc_html_e('Address:', 'relicwp-helper'); ?></h2>

				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('address_icon') ); ?>"><?php esc_html_e('Icon Class', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('address_text') ); ?>"><?php esc_html_e('Title', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('address') ); ?>"><?php esc_html_e('Content', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('address_link') ); ?>"><?php esc_html_e('Link (optional)', 'relicwp-helper'); ?></label>
			...
			<div class="pdwp-infos">
				<h2><?php esc_html_e('Phone:', 'relicwp-helper'); ?></h2>

				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('phone_icon') ); ?>"><?php esc_html_e('Icon Class', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('phone_text') ); ?>"><?php esc_html_e('Title', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('phone') ); ?>"><?php esc_html_e('Content', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('phone_link') ); ?>"><?php esc_html_e('Link (optional)', 'relicwp-helper'); ?></label>
			...
			<div class="pdwp-infos">
				<h2><?php esc_html_e('Mobile:', 'relicwp-helper'); ?></h2>

				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('mobile_icon') ); ?>"><?php esc_html_e('Icon Class', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('mobile_text') ); ?>"><?php esc_html_e('Title', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('mobile') ); ?>"><?php esc_html_e('Content', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('mobile_link') ); ?>"><?php esc_html_e('Link (optional)', 'relicwp-helper'); ?></label>
			...
			<div class="pdwp-infos">
				<h2><?php esc_html_e('Fax:', 'relicwp-helper'); ?></h2>

				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('fax_icon') ); ?>"><?php esc_html_e('Icon Class', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('fax_text') ); ?>"><?php esc_html_e('Title', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('fax') ); ?>"><?php esc_html_e('Content', 'relicwp-helper'); ?></label>
			...
			<div class="pdwp-infos">
				<h2><?php esc_html_e('Email:', 'relicwp-helper'); ?></h2>

				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('email_icon') ); ?>"><?php esc_html_e('Icon Class', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('email_text') ); ?>"><?php esc_html_e('Title', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('email') ); ?>"><?php esc_html_e('URL', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('emailtxt') ); ?>"><?php esc_html_e('URL Text', 'relicwp-helper'); ?></label>
			...
			<div class="pdwp-infos">
				<h2><?php esc_html_e('Website:', 'relicwp-helper'); ?></h2>

				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('web_icon') ); ?>"><?php esc_html_e('Icon Class', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('web_text') ); ?>"><?php esc_html_e('Title', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('web') ); ?>"><?php esc_html_e('URL', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('webtxt') ); ?>"><?php esc_html_e('URL Text', 'relicwp-helper'); ?></label>
			...
			<div class="pdwp-infos">
				<h2><?php esc_html_e('Skype:', 'relicwp-helper'); ?></h2>

				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('skype') ); ?>"><?php esc_html_e('Username', 'relicwp-helper'); ?></label>
				...
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id('skypetxt') ); ?>"><?php esc_html_e('Text', 'relicwp-helper'); ?></label>
...
register_widget( 'RelicWP_Helper_Contact_Info_Widget' );