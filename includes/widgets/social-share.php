...
if ( ! class_exists( 'RelicWP_Helper_Social_Share_Widget' ) ) {
	class RelicWP_Helper_Social_Share_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'pdvs_social_share',
				esc_html__( '&raquo; Social Share', 'relicwp-helper' ),
				array(
					'classname'   => 'widget-pdwp-social-share social-share',
					'description' => esc_html__( 'Display social sharing buttons on your sidebar.', 'relicwp-helper' ),
		...
		public function social_array() {
			...
			// Array
			$return = apply_filters( 'pdvs_social_share_buttons', array(
				'twitter' => array(
					'name' 	=> 'Twitter',
					'title' => esc_html__( 'Share on Twitter', 'relicwp-helper' ),
				...
				'facebook' => array(
					'name' 	=> 'Facebook',
					'title' => esc_html__( 'Share on Facebook', 'relicwp-helper' ),
				...
				'googleplus' => array(
					'name' 	=> 'Google+',
					'title' => esc_html__( 'Share on Google+', 'relicwp-helper' ),
				...
				'pinterest' => array(
					'name' 	=> 'Pinterest',
					'title' => esc_html__( 'Share on Pinterest', 'relicwp-helper' ),
				...
				'linkedin' => array(
					'name' 	=> 'LinkedIn',
					'title' => esc_html__( 'Share on LinkedIn', 'relicwp-helper' ),
				...
				'viber' => array(
					'name' 	=> 'Viber',
					'title' => esc_html__( 'Share on Viber', 'relicwp-helper' ),
				...
				'vk' => array(
					'name' 	=> 'VK',
					'title' => esc_html__( 'Share on VK', 'relicwp-helper' ),
				...
				'reddit' => array(
					'name' 	=> 'Reddit',
					'title' => esc_html__( 'Share on Reddit', 'relicwp-helper' ),
				...
				'tumblr' => array(
					'name' 	=> 'Tumblr',
					'title' => esc_html__( 'Share on Tumblr', 'relicwp-helper' ),
				...
				'viadeo' => array(
					'name' 	=> 'Viadeo',
					'title' => esc_html__( 'Share on Viadeo', 'relicwp-helper' ),
					...
					foreach( $social_share as $social_key ) {
						...
						echo '<li class="'. esc_attr( $social_key ) .'">';
							...
							echo '<a href="'. esc_url($url) .'" title="'. esc_attr( $title ) .'" '. wp_kses_post( $add_style ) . ' onclick="owpShareOnClick( this.href );return false;">';
								...
								if( $social_name ) {
									echo '<span class="owp-social-name">' . esc_html($name) . '</span>';
								}
		...
		public function form( $instance ) {
			...
			$instance = wp_parse_args( ( array ) $instance, array(
				'title'           	 => esc_attr__( 'Please share this', 'relicwp-helper' ),
				'style' 	  		 => esc_html__( 'Minimal', 'relicwp-helper' ),
				'border_radius'   	 => '',
				'border_color'   	 => '',
				'bg_color'   	     => '',
				'color'   	         => '',
			...
			<p>
				...
				<select class='widefat' name="<?php echo esc_attr( $this->get_field_name( 'style' ) ); ?>" id="<?php echo esc_attr( $this->get_field_id( 'style' ) ); ?>">
					<option value="minimal" <?php selected( $instance['style'], 'minimal' ) ?>><?php esc_html_e( 'Minimal', 'relicwp-helper' ); ?></option>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'border_color' ) ); ?>"><?php esc_html_e( 'Minimal Style: Border Color', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'bg_color' ) ); ?>"><?php esc_html_e( 'Minimal Style: Background Color', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label class="color-label" for="<?php echo esc_attr( $this->get_field_id( 'color' ) ); ?>"><?php esc_html_e( 'Minimal Style: Color', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'twitter_username' ) ); ?>"><?php esc_html_e( 'Twitter Username', 'relicwp-helper' ); ?>:</label>
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'social_name' ); ?>"><?php esc_html_e( 'Show Social Name', 'relicwp-helper' ); ?></label>
			</p>

			<h3><?php esc_html_e( 'Social Share','relicwp-helper' ); ?></h3>
			<?php
			// Social array
		...
		public function colors( $args, $instance ) {
			...
			if ( $bg_color
				...
				|| $border_color ) : ?>
				<style>
					#<?php echo $id; ?>.widget-pdwp-social-share ul li a {
        ...
        public function scripts() {
            ...
            if ( is_active_widget( '', '', 'pdvs_social_share' ) ) {
            	wp_enqueue_script( 'pt-social-share', RTHP_URL . 'includes/widgets/js/share.min.js', array( 'jquery' ), false, true );
            }
        }

	}
}
register_widget( 'RelicWP_Helper_Social_Share_Widget' );