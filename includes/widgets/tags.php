...
if ( ! class_exists( 'RelicWP_Helper_Tags_Widget' ) ) {
	class RelicWP_Helper_Tags_Widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				'pdvs_tags',
				esc_html__( '&raquo; Tags Cloud', 'relicwp-helper' ),
				array(
					'classname'   => 'widget-pdwp-tags tags-widget',
					'description' => esc_html__( 'A cloud of your most used tags.', 'relicwp-helper' ),
		...
		public function widget( $args, $instance ) {
			...
			if ( ! empty( $instance['title'] ) ) {
				...
				if ( 'post_tag' == $current_taxonomy ) {
					$title = esc_html__( 'Tags', 'relicwp-helper' );
				} else {
			 ...
			 *
			 * @since 1.0.0
			 * @since 1.0.0 Added taxonomy drop-down.
			 *
			 * @see wp_tag_cloud()
			 *
		...
		public function form( $instance ) {
			...
			case 0:
				echo '<p>' . esc_html__( 'The tag cloud will not be displayed since there are no taxonomies that support the tag cloud widget.', 'relicwp-helper' ) . '</p>';
				printf( $input, '' );
				break;
			...
			default:
				printf(
					...
					$id,
					esc_html__( 'Taxonomy:', 'relicwp-helper' ),
					$name
				);
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'padding' ) ); ?>"><?php esc_html_e( 'Padding:', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'bg_color' ) ); ?>"><?php esc_html_e( 'Background Color:', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'bg_hover_color' ) ); ?>"><?php esc_html_e( 'Background Hover Color:', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'link_color' ) ); ?>"><?php esc_html_e( 'Link Color:', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'link_hover_color' ) ); ?>"><?php esc_html_e( 'Link Hover Color:', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'border_color' ) ); ?>"><?php esc_html_e( 'Border Color:', 'relicwp-helper' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'border_hover_color' ) ); ?>"><?php esc_html_e( 'Border Hover Color:', 'relicwp-helper' ); ?></label>
			...
			<p>
				...
				<select class="widget-select widefat" name="<?php echo esc_attr( $this->get_field_name('text_transform') ); ?>" id="<?php echo esc_attr( $this->get_field_id('position') ); ?>">
					...
					<option value="none" <?php selected( $instance['text_transform'], 'none' ) ?>><?php esc_html_e( 'None', 'relicwp-helper' ); ?></option>
				</select>
			</p>
...
register_widget( 'RelicWP_Helper_Tags_Widget' );