...
require_once RTHP_PATH . '/includes/panel/classes/importers/parser/compat.php';

/** WXR_Parser class */
require_once RTHP_PATH . '/includes/panel/classes/importers/parser/class-wxr-parser.php';

/** WXR_Parser_SimpleXML class */
require_once RTHP_PATH . '/includes/panel/classes/importers/parser/class-wxr-parser-simplexml.php';

/** WXR_Parser_XML class */
require_once RTHP_PATH . '/includes/panel/classes/importers/parser/class-wxr-parser-xml.php';

/** WXR_Parser_Regex class */
require_once RTHP_PATH . '/includes/panel/classes/importers/parser/class-wxr-parser-regex.php';
