...
Class WizardAjax {
    ...
    public function ajax_demo_data() {
            ...
            <div class="owp-popup-text">
                ...
                <div class="owp-required-plugins-wrap">
                    ...
                    <div class="owp-required-plugins pt-plugin-installer">
                        <?php
                        PdWP_Demos::required_plugins($free, 'free');
                        PdWP_Demos::required_plugins($premium, 'premium');
                        ?>
                    </div>
                </div>
        ...
        <form method="post" id="owp-demo-import-form">
            ...
            <input type="submit" name="submit" class="owp-button owp-import" value="<?php esc_html_e('Import', 'relicwp-helper'); ?>"  />
        ...
        <div class="owp-error" style="display: none;">
            <p ><?php esc_html_e("The import didn't import well please contact the support.", 'relicwp-helper'); ?></p>
        </div>
        </div>
