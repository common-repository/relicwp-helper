...
$window.on( 'load', function() {
	...
	pdwpWooVariableImage();
} );

/* ==============================================
WOOCOMMERCE VARIABLE IMAGE PRODUCT
============================================== */
function pdwpWooVariableImage() {
	"use strict"
	...
	$j.fn.wc_variations_image_update = function( variation ) {
		var $form 				= this,
			...
			$product_link 		= $product.find( 'div.images a.woocommerce-main-image:eq(0), div.images a.woocommerce-main-image:eq(1), div.images a.pdwp-lightbox-trigger:eq(0), div.images a.pdwp-lightbox-trigger:eq(1), div.images .first-thumbnail:not(.slick-cloned) a.woo-thumbnail:eq(3)' );
